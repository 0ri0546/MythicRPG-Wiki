...
/** Lightweight wireframe preview; no client tick scan and at most 144 boxes. */
public final class BuildingPlan2DClient {
    ...
    private BuildingPlan2DClient() {
    }

    public static void handle(BuildingPlan2DPreviewPayload payload) {
        if (payload.action() == BuildingPlan2DPreviewPayload.CLEAR) {
            clear();
            return;
        }
