...
public record SignatureDishOpenPayload(
        int handId,
        String name,
        int bonusId,
        String iconId,
    ...
    public static final Id<SignatureDishOpenPayload> ID =
            new Id<>(Identifier.of(MythicRPG.MOD_ID, "signature_dish_open"));

    public static final PacketCodec<RegistryByteBuf, SignatureDishOpenPayload> CODEC = PacketCodec.ofStatic(
            (buffer, payload) -> {
            ...
            buffer -> {
                ...
                return new SignatureDishOpenPayload(handId, name, bonusId, iconId, ingredientIds);
            }
    );

    public SignatureDishOpenPayload {
    ...
    public static SignatureDishOpenPayload empty(int handId) {
        return new SignatureDishOpenPayload(
                handId,
                "Signature Dish",
                SignatureBonus.DAMAGE.ordinal(),
                "minecraft:bowl",
                List.of()
        );
    }
