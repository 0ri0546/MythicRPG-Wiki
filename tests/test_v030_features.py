...
class V030FeatureTests(unittest.TestCase):
    ...
    def test_v030_components_versions_and_release_constraints(self) -> None:
        ...
        self.assertEqual("0.4.0", CATALOG["schema_version"])
        self.assertEqual("0.4.0", SNAPSHOT["project_version"])
        ...
        self.assertEqual("0.4.0", package["version"])
        self.assertEqual("0.4.0", lock["version"])
        self.assertEqual("0.4.0", lock["packages"][""]["version"])
